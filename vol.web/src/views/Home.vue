      ...
      <div class="home-content">
        <div class="home-left">
          ...
          <div class="home-list">
            ...
            <!-- 图表工作台入口 -->
            <div class="list-item" style="background: #e6f7ff; border: 1px solid #91d5ff; cursor: pointer;" @click="goToChartDashboard">
              <div class="content">
                <div class="content-right">
                  <div class="name">
                    图表工作台
                ...
                <div class="content-icon">
                  <i class="el-icon-data-line" style="font-size: 40px; color: #1890ff;"></i>
                </div>
              </div>
            </div>
          </div>
...
// 跳转到图表工作台
const goToChartDashboard = () => {
  proxy.$router.push('/chartDashboard')
}
